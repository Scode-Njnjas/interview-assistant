export interface ElectronAPI {
  ...
  getConfig: () => Promise<{ apiKey: string; model: string; apiProvider?: string; extractionModel?: string; solutionModel?: string; debuggingModel?: string; answerModel?: string; speechRecognitionModel?: string; candidateProfile?: any; azureEndpoint?: string; azureApiVersion?: string }>
  updateConfig: (config: { apiKey?: string; model?: string; apiProvider?: string; extractionModel?: string; solutionModel?: string; debuggingModel?: string; answerModel?: string; speechRecognitionModel?: string; candidateProfile?: any; azureEndpoint?: string; azureApiVersion?: string }) => Promise<boolean>
  fetchProviderModels: (
    provider: string,
    apiKey: string,
    options?: { endpoint?: string; apiVersion?: string; forceRefresh?: boolean }
  ) => Promise<{
    success: boolean;
    models: Array<{
      id: string;
