                      ...
                      <div key={sectionIndex} className="mb-6">
                        ...
                        <div className="pl-1">
                          {section.content.map((line, lineIndex) => {
                            ...
                            if (line.trim().startsWith('```')) {
                              ...
                              if (line.trim() === '```' || line.trim().startsWith('```')) {
                                ...
                                if (codeBlockEndIndex > lineIndex) {
                                  ...
                                  return (
                                    <div key={lineIndex} className="font-mono text-xs text-green-300 bg-black/60 p-3 my-2 rounded overflow-x-auto border border-white/10">
                            ...
                            // Regular text
                            return <div key={lineIndex} className="my-1.5 text-white/90">{line}</div>;
                          })}
                        </div>
                      </div>
                    ));
